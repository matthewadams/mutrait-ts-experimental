...
StartTest((t) => {
  t.it('Repeating creation with the same requirements should not call mixin functions and use cache', (t) => {
    ...
    class SomeMixin1 extends Mixin([Base], (base: ClassUnion<typeof Base>) => {
      count1++
    ...
    class SomeMixin2 extends Mixin([Base], (base: ClassUnion<typeof Base>) => {
      count2++
    ...
    class SomeMixin3 extends Mixin([Base], (base: ClassUnion<typeof Base>) => {
      count3++
  ...
  t.it('Repeating creation with different base class should call mixin functions', (t) => {
    ...
    class SomeMixin1 extends Mixin([], (base: ClassUnion<AnyConstructor>) => {
      count1++
    ...
    class SomeMixin2 extends Mixin([], (base: ClassUnion<AnyConstructor>) => {
      count2++
  ...
  t.it('Should be possible to use `derive` over the non-mixin class, inheriting from mixin class', (t) => {
    ...
    class SomeMixin2 extends Mixin([SomeMixin1], (base: ClassUnion<typeof SomeMixin1>) => {
      count2++
    ...
    class SomeMixin3 extends Mixin([SomeMixin1, SomeMixin2], (base: ClassUnion<typeof SomeMixin1, typeof SomeMixin2>) => {
      count3++
  ...
  t.it('Should be possible to use `derive` over the non-mixin class, inheriting from mixin class #2', (t) => {
    ...
    class SomeMixin4 extends Mixin([SomeMixin3, SomeMixin2], (base: ClassUnion<typeof SomeMixin3, typeof SomeMixin2>) => {
      count4++
